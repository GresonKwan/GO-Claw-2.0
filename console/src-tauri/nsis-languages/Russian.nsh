...
LangString qwenpawCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled qwenpaw command to your user PATH. You can change it later by reinstalling or uninstalling GO CLAW."
LangString qwenpawCliPathCheckbox ${LANG_RUSSIAN} "Add qwenpaw to PATH"
LangString qwenpawCliPathAdded ${LANG_RUSSIAN} "Added qwenpaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_RUSSIAN} "Skipped adding qwenpaw to user PATH"
LangString qwenpawCliPathMissing ${LANG_RUSSIAN} "qwenpaw.exe was not found; skipped PATH update"
LangString qwenpawCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
LangString qwenpawStopBackendPrompt ${LANG_RUSSIAN} "GO CLAW всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте GO CLAW (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
