...
LangString qwenpawCliPathPageDescription ${LANG_JAPANESE} "This adds the bundled qwenpaw command to your user PATH. You can change it later by reinstalling or uninstalling GO CLAW."
LangString qwenpawCliPathCheckbox ${LANG_JAPANESE} "Add qwenpaw to PATH"
LangString qwenpawCliPathAdded ${LANG_JAPANESE} "Added qwenpaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_JAPANESE} "Skipped adding qwenpaw to user PATH"
...
LangString qwenpawStopBackendPrompt ${LANG_JAPANESE} "GO CLAW がまだ実行中で、インストーラーが置き換える必要のあるファイルを使用しています。$\n$\nGO CLAW を終了してから（システムトレイをご確認ください）、「再試行」をクリックして続行してください。「キャンセル」をクリックするとインストールを中止します。"
