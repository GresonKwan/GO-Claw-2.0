...
LangString qwenpawCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled qwenpaw command to your user PATH. You can change it later by reinstalling or uninstalling GO CLAW."
LangString qwenpawCliPathCheckbox ${LANG_ENGLISH} "Add qwenpaw to PATH"
LangString qwenpawCliPathAdded ${LANG_ENGLISH} "Added qwenpaw to user PATH"
LangString qwenpawCliPathSkipped ${LANG_ENGLISH} "Skipped adding qwenpaw to user PATH"
...
LangString qwenpawStopBackendPrompt ${LANG_ENGLISH} "GO CLAW is still running and is using files the installer needs to replace.$\n$\nPlease quit GO CLAW (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
