...
[![Last Commit](https://img.shields.io/github/last-commit/agentscope-ai/QwenPaw)](https://github.com/GresonKwan/GO-Claw-2.0)
[![License](https://img.shields.io/badge/license-Apache%202.0-red.svg?logo=apache&label=License)](LICENSE)
[![Code Style](https://img.shields.io/badge/code%20style-black-black.svg?logo=python&label=CodeStyle)](https://github.com/psf/black)
[![GitHub Stars](https://img.shields.io/github/stars/agentscope-ai/QwenPaw?style=flat&logo=github&color=yellow&label=Stars)](https://github.com/GresonKwan/GO-Claw-2.0/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/agentscope-ai/QwenPaw?style=flat&logo=github&color=purple&label=Forks)](https://github.com/GresonKwan/GO-Claw-2.0/network)
...
Ваш персональный AI-ассистент — разверните локально или в облаке, расширяйте с помощью Skills и Plugins, подключайтесь через любые каналы.
...
| **Расширяемость**                         | Skills для планирования, документов, браузера, новостей и многого другого. Архитектура плагинов с маркетплейсом. Интеграция MCP для внешних инструментов. Комбинируйте в целевые рабочие процессы.  |
| **Доступен везде**                        | DingTalk, Lark, WeChat, Discord, Telegram, iMessage, QQ — один экземпляр, все каналы. Console, TUI и десктопное приложение для прямого доступа.                                            |
...
> <br>
>
> - **Автоматизация и планирование**: Настройте повторяющиеся задачи — дайджесты новостей, генерация отчётов, мультиканальная рассылка — всё по вашему расписанию.
> - **Код и разработка**: Читайте, редактируйте, проверяйте и тестируйте код в проектах; Coding Mode помогает быстро находить и понимать код.
> - **Обработка документов**: Чтение, запись и преобразование PDF, Word, Excel и PowerPoint.
> - **Сбор информации**: Поиск в интернете, отслеживание подписок, суммаризация видео и поиск в персональной базе знаний.
> - **Мультиканальные операции**: Отправка оповещений, дайджестов или AI-контента в DingTalk, Lark, Discord, Telegram и другие — одновременно или по каналам.
> - **Пользовательские сценарии**: Объединяйте встроенные возможности, плагины и запланированные задачи в сценарии под ваши задачи.
>
> </details>
...
Если вы предпочитаете самостоятельно управлять Python (требуется Python >= 3.11, < 3.14):
...
Затем откройте **http://127.0.0.1:8088/** для доступа к консоли. Конфигурация, память и навыки сохраняются в томе `qwenpaw-data`; настройки провайдеров моделей и API-ключи — в томе `qwenpaw-secrets`; архивы резервных копий — в томе `qwenpaw-backups`. Для передачи API-ключей (например, `DASHSCOPE_API_KEY`) добавьте `-e VAR=value` или `--env-file .env` в команду `docker run`.
...
>   agentscope/qwenpaw:latest
> ```
> Сопоставление портов (`-p`) не требуется; контейнер напрямую использует сеть хоста. Обратите внимание, что все порты контейнера будут доступны на хосте, что может вызвать конфликты, если порт уже занят.
>

Образ собирается с нуля. Если нужно собрать образ самостоятельно, см. раздел [Build Docker image](scripts/README.md#build-docker-image) в `scripts/README.md`, затем отправьте в свой реестр образов.
...
### Вариант 7: Десктопное приложение (Beta)
...
- ✅ **Визуальный интерфейс**: Автоматически открывает окно приложения, не нужно вручную вводить адрес
- ⚠️ **Beta-стадия**: Функции продолжают совершенствоваться, приветствуется обратная связь

#### Первый запуск

**Важно**: Первый запуск может занять 10–60 секунд (в зависимости от конфигурации вашей системы). Приложению необходимо инициализировать Python-окружение и загрузить зависимости. Пожалуйста, дождитесь автоматического открытия окна.
...
После установки настройте модель в **Консоль → Настройки → Модели**, затем изучите:

- [Добавьте Skills](https://qwenpaw.agentscope.io/docs/skills) для расширения возможностей (PDF, Office, браузер, новости и т.д.)
- [Настройте каналы](https://qwenpaw.agentscope.io/docs/channels) для DingTalk, Lark, Discord и других
- [Настройте Cron](https://qwenpaw.agentscope.io/docs/cron) для запланированных задач и автоматизации
- [Попробуйте Coding Mode](https://qwenpaw.agentscope.io/docs/coding-mode) для IDE-стиля работы с кодом
- Полное [руководство по быстрому старту](https://qwenpaw.agentscope.io/docs/quickstart) со всеми опциями и шагами проверки
...
| [Десктопное приложение](https://qwenpaw.agentscope.io/docs/desktop)  | Установка и использование десктопного приложения |
| [Модели](https://qwenpaw.agentscope.io/docs/models)                  | Настройка облачных, локальных и пользовательских провайдеров |
| [Каналы](https://qwenpaw.agentscope.io/docs/channels)                | DingTalk, Lark, QQ, Discord, iMessage и другие |
| [Coding Mode](https://qwenpaw.agentscope.io/docs/coding-mode)        | Трёхпанельная Web IDE для задач с кодом         |
| [Skills](https://qwenpaw.agentscope.io/docs/skills)                  | Расширение и настройка возможностей             |
| [Плагины](https://qwenpaw.agentscope.io/docs/plugins)                | Система плагинов и Plugin Market                 |
| [MCP](https://qwenpaw.agentscope.io/docs/mcp)                          | Управление MCP-клиентами                        |
| [Persona](https://qwenpaw.agentscope.io/docs/persona)                | Настройка личности агента (SOUL / PROFILE)       |
| [Память](https://qwenpaw.agentscope.io/docs/memory)                  | Долговременная семантическая память (ReMe)       |
...
| [Контекст](https://qwenpaw.agentscope.io/docs/context)               | Управление контекстом на базе Scroll             |
...
| [Интеграция ACP](https://qwenpaw.agentscope.io/docs/acp-integration) | Интеграция Agent Communication Protocol         |
| [CLI](https://qwenpaw.agentscope.io/docs/cli)                        | Init, cron-задачи, skills, очистка              |
| [Практика агентных команд](https://qwenpaw.agentscope.io/docs/practice-agent-team) | Руководство по развертыванию мультиагентных команд |
| [FAQ](https://qwenpaw.agentscope.io/docs/faq)                        | Частые вопросы и устранение неполадок           |

Полная документация: [qwenpaw.agentscope.io/docs](https://qwenpaw.agentscope.io/docs)
...
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------- |
| **Горизонтальное расширение**                   | Больше каналов, моделей, навыков, MCP — **приветствуются вклады сообщества**                               | Ищем участников |
...
Присоединяйтесь к обсуждениям на [GitHub Discussions](https://github.com/GresonKwan/GO-Claw-2.0/discussions), чтобы обсуждать идеи или браться за задачи.
