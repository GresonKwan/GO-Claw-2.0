...
已确认：单笔最低 ￥1、最高 ￥100,000；快捷金额 ￥10/￥50/￥100/￥200；用户展示“￥1对应500万算力”；每账户每日累计充值上限 ￥100,000；退款转客服处理；暂不提供发票；微信支付商户号为 `1749383281`；GO CLAW 唯一下单 AppID 为“未来AI工坊” `wx04d715aaaa2bd0ed`。
